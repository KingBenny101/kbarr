...
var Schema = []SettingDef{
	...
	{Key: "preferredSubtitleLanguage", Type: TypeString, Default: "multi,eng,jpn,spa,por,ara,fre,ger", Label: "Preferred subtitle language order", Description: "Ordered list of preferred subtitle languages. First = most preferred. Torrents whose name indicates a higher-ranked language score higher.", Group: "indexer", Section: "Indexer", Widget: "reorder"},
	...
	{Key: "releaseGroupPreferenceOrder", Type: TypeString, Default: "Erai-raws,SubsPlease,EMBER,Judas,ASW,Yameii,Golumpa,Nekomoe kissaten,ToxicRUS,Baws,HorribleSubs", Label: "Release group preference order", Description: "Ordered list of preferred release groups. First = most preferred.", Group: "indexer", Section: "Indexer", Widget: "reorder"},
	{Key: "releaseGroupPriorityMode", Type: TypeSelect, Default: "tie-break", Label: "Release group priority mode", Description: "Tie-break: prefer listed groups only when quality/subtitle are equal. Strong: listed groups can outrank higher quality releases.", Group: "indexer", Section: "Indexer", Options: []string{"tie-break", "strong"}},
