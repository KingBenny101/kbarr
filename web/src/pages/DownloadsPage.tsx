                        ...
                        <ScrollArea type="auto">
                            <Table striped highlightOnHover withTableBorder withColumnBorders verticalSpacing="md">
                                <Table.Thead>
                                    <Table.Tr>
                                        <Table.Th ta="center">
                                            <UnstyledButton onClick={() => toggleSort("title")} style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", gap: 4 }}>
                                        ...
                                        <Table.Th ta="center">
                                            <UnstyledButton onClick={() => toggleSort("size")} style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", gap: 4 }}>
                                                Size <SortIcon field="size" sortField={sortField} sortDir={sortDir} />
                                            </UnstyledButton>
                                        </Table.Th>
                                        <Table.Th ta="center">
                                            <UnstyledButton onClick={() => toggleSort("seeders")} style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", gap: 4 }}>
                                                Seeders <SortIcon field="seeders" sortField={sortField} sortDir={sortDir} />
                                            </UnstyledButton>
                                        </Table.Th>
                                        <Table.Th ta="center">Hash</Table.Th>
                                        <Table.Th ta="center">
                                            <UnstyledButton onClick={() => toggleSort("added")} style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", gap: 4 }}>
                                                Added <SortIcon field="added" sortField={sortField} sortDir={sortDir} />
                                            </UnstyledButton>
                                        </Table.Th>
                                        <Table.Th ta="center">
                                            <UnstyledButton onClick={() => toggleSort("status")} style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", gap: 4 }}>
                                                Status <SortIcon field="status" sortField={sortField} sortDir={sortDir} />
                                            </UnstyledButton>
                                        </Table.Th>
                                        <Table.Th w={72} ta="center">Actions</Table.Th>
                                    </Table.Tr>
                                </Table.Thead>
                                <Table.Tbody>
                                    {loading ? (
