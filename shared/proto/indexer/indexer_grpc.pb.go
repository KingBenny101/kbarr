...
const (
	IndexerService_Search_FullMethodName = "/indexer.IndexerService/Search"
)
...
func (c *indexerServiceClient) Search(ctx context.Context, in *ProwlarrSearchRequest, opts ...grpc.CallOption) (*ProwlarrSearchResponse, error) {
...
func (UnimplementedIndexerServiceServer) Search(context.Context, *ProwlarrSearchRequest) (*ProwlarrSearchResponse, error) {
...
func _IndexerService_Search_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IndexerServiceServer).Search(ctx, req.(*ProwlarrSearchRequest))
	}
