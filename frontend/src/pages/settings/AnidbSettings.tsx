    ...
    return (
        <section className="group space-y-6">
            ...
            <FieldGroup>
                ...
                <Field orientation="responsive" className="justify-between gap-4 md:gap-8">
                    <div className="flex-1 space-y-1">
                        <FieldLabel htmlFor="anidbSyncInterval" className="text-base font-semibold">Sync Interval (m)</FieldLabel>
                        <FieldDescription className="text-sm">How often to sync with AniDB (default: 1440m).</FieldDescription>
                    </div>
                    <Input
